...
public class DataEnrichmentMapper2 extends RichWindowFunction<Optional<String>, String, Integer, GlobalWindow> implements Serializable
{
	Logger						LOG	= LoggerFactory.getLogger(DataEnrichmentMapper2.class);
	...
	@Override
	public void apply(Integer key, GlobalWindow window, Iterable<Optional<String>> queryablePcns, Collector<String> out) throws Exception
	{
		for (Optional<String> queryablePcn : queryablePcns)
		{
			...
			out.collect(gson.toJson(enrichedData));
		}		
	}
}